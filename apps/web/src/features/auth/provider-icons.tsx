/** Provider marks. Google keeps its brand colours; the rest follow the ink. */
...
export const ssoIcon = (
  <svg aria-hidden="true" focusable="false" viewBox="0 0 16 16">
    <path
      d="M4.5 4.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm0 2a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM8 7.25h7.5V11H14V8.75h-1.5V11H11V8.75H8Z"
      fill="currentColor"
    />
  </svg>
);
